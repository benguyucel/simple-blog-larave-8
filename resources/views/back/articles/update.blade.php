...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      @endforeach
        ...
        @endif
        <form method="post" action="{{route('admin.makaleler.update',$article->articlesId)}}" enctype="multipart/form-data" >
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="category" class="form-control" required>
                    ...
                    <option @if($article->categoryId==$category->categoryId) selected @endif value="{{$category->categoryId}}">{{$category->categoryName}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                <label>Makale Fotoğraf</label>
                <img width="400" class="img-fluid img-thumbnail " src="{{asset($article->image)}}" alt="">
                <br>
