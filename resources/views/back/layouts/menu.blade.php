    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="{{ asset('back/') }}/index.html">
                <div class="sidebar-brand-icon rotate-n-15">
                </div>
                <div class="sidebar-brand-text mx-3">Blog ST ADMIN</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse @if(Request::segment(2)=='makaleler') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2)=='makaleler' and Request::segment(3)==" create")
                            active @endif" " href=" {{ route('admin.makaleler.create') }}">Makale
                            Oluştur</a>
                    </div>
                </div>
            </li>

               <!-- Nav Item - Pages Collapse Menu Makaleler-->
               <li class="nav-item">
                ...
                <div id="collapsePage" class="collapse @if(Request::segment(2)=='sayfalar') show @endif"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2)=='sayfalar' and Request::segment(3)==" olustur")
                            active @endif" " href=" {{ route('admin.page.create') }}">Sayfa
                            Oluştur</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item @if(Request::segment(2)=="comment") active @endif">
